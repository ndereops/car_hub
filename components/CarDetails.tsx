            ...
            >
              ...
              >
                <Dialog.Panel
                 ...
                 max-h-[90vh] overflow-y-auto text-left shadow-xl transition-all
                 transform rounded-2xl bg-white gap-5 flex flex-col p-6"
                >
                  <button
                    type="button"
                  ...
                  <div className=" flex-1 flex flex-col gap-3">
                    <div
                      className=" relative w-full h-40 bg-pattern bg-center 
                        rounded-lg bg-cover"
                    >
                      <Image
